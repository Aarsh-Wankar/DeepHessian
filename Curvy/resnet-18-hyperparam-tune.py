...
def load_datasets():
    """Load SVHN training and test datasets"""
...
def train_resnet18_sweep():
    """
    Train ResNet-18 model with W&B sweep hyperparameters
...
def main():
    ...
    parser = argparse.ArgumentParser(description='ResNet-18 Curvy Optimizer Training')
